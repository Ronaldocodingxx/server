...
const verifyToken = require('../middleware/auth'); // Importieren statt definieren
    ...
    try {
        ...
        try {
            ...
            await transporter.sendMail({
                from: 'SyntheChat <noreply@synthechat.com>',
                to: email,
...
// Rest des Codes bleibt gleich, aber bitte aktualisieren Sie die URLs für Passwort-Reset etc.
// von http://localhost:4200 auf https://frontend-r4x5k.ondigitalocean.app
...
// Rest Ihrer auth.js-Datei bleibt gleich, mit den aktualisierten URLs für die DigitalOcean-Domain
// Stellen Sie sicher, dass alle http://localhost:4200 auf https://frontend-r4x5k.ondigitalocean.app aktualisiert werden
